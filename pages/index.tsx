    ...
    <>
      <div className='z-10'>
        <div className='relative flex justify-center'>
          ...
          <>
            <div className='absolute -z-10 w-[400%] md:w-full min-h-full mix-blend-multiply grayscale-[50%]'>
            ...
            <div className='absolute -z-10 w-[400%] sm:w-full min-h-full mix-blend-multiply grayscale-[50%}'>
            ...
            <div className='absolute -z-10 w-[400%] sm:w-full min-h-full mix-blend-multiply grayscale-[50%] translate-x-200'>
