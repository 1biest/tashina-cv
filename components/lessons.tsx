...
const lessons = () => {
  return (
    <>
        <div id='tutorials' className='z-20'>
            <h3 className='text-2xl font-light text-center'>Tutorials</h3>
            <p className='text-sm pt-4 px08 text-center'>Everything you need to know to get started with Web3 in the Cosmoverse,<br /> the interconnected web of blockchains.</p>
