        ...
        <div className='z-20 relative'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 items-center justify-between mt-10 px-4 md:px-20 bg-gradient-to-l from-[rgba(180,190,200,0.6)] to-[rgba(230,240,250,0.2)] backdrop-blur-2xl rounded-xl'>
                <div className='col-span-1'>
                    <h1 className='text-center pt-8 md:pt-0 text-6xl lg:text-[140px] font-semibold'>1</h1>
                </div>
            ...
            <div className='md:-translate-x-20 grid grid-cols-1 md:grid-cols-4 items-center justify-between mt-10 px-4 md:px-20 bg-gradient-to-r from-[rgba(180,190,200,0.6)] to-[rgba(230,240,250,0.2)] backdrop-blur-2xl rounded-xl'>
                ...
                <div className='col-span-1'>
                    <h1 className='text-center pt-8 md:pt-0 text-6xl lg:text-[140px] font-semibold'>2</h1>
                </div>
            </div>
            <div className='md:translate-x-20 grid grid-cols-1 md:grid-cols-4 items-center justify-between mt-10 px-4 md:px-20 bg-gradient-to-l from-[rgba(180,190,200,0.6)] to-[rgba(230,240,250,0.2)] backdrop-blur-2xl rounded-xl'>
                <div className='col-span-1'>
                    <h1 className='text-center pt-8 md:pt-0 text-6xl lg:text-[140px] font-semibold'>3</h1>
                </div>
                <div className='p-8 px-4 lg:px-8 space-y-4 col-span-3'>
