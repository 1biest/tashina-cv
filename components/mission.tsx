  ...
  return (
    <>
        <div className='z-20 relative'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 items-center justify-between mt-10 px-20 bg-gradient-to-l from-[rgba(30,40,60,0.5)] to-transparent backdrop-blur-2xl rounded-xl'>
            ...
            <div className='-translate-x-20 grid grid-cols-1 md:grid-cols-4 items-center justify-between mt-10 px-20 bg-gradient-to-r from-[rgba(30,40,60,0.5)] to-transparent backdrop-blur-2xl rounded-xl'>
                <div className='p-8 space-y-4 col-span-3'>
                    <h3 className='text-3xl font-semibold text-right gradientText'>Decentralized</h3>
                    <p className='text-md font-extralight text-right'>Crypto is for the people, by the people. No corporation or central entity has control of your intellectual property. Everyone collectively owns the network. It doesn&apos;t matter who you are, or where you are from, everyone is welcome!</p>
                </div>
                <div className='col-span-1'>
