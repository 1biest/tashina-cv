    ...
    <>
        <div id='about' className='w-full z-20 relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 space-x-6'>
            <div className=''>
                ...
                <p className='pt-4'>Tashina is a Web3 coach motivating individuals and professionals to get involved with decentralized systems.</p>
                <p className='pt-4'>Residing in Canada, Tashina spends time hiking the rocky mountains and traveling to new inspiring destinations.</p>
                <p className='pt-4'>Say hi! Reach out over social media and lets work togeher in making Web3 inclusive for everyone.</p>
                <Socials />
                <div className='mt-4 rounded-xl backdrop-blur-2xl'>
                    <Image src={Tashina4} className='rounded-xl contrast-[110%] opacity-80' />
                </div>
            </div>
            <div className="lg:pt-10 contrast-[110%] opacity-80">
                <div className='py-2'>
                    <Image src={Tashina1} className='rounded-xl' />
                </div>
                <div className='py-2'>
                    <Image src={Tashina5} className='rounded-xl' />
                </div>
                <div className='py-2'>
                    <Image src={Tashina2} className='rounded-xl' />
                </div>
            </div>
            <div className="lg:pt-40 contrast-[110%] opacity-80">
                <div className='py-2'>
                    <Image src={Tashina3} className='rounded-xl' />
                </div>
                <div className='py-2'>
                    <Image src={Tashina6} className='rounded-xl' />
                </div>
            </div>
        </div>
    </>
