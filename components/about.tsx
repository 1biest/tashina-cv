    ...
    <>
        <div id='about' className='w-full z-20 relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 space-x-6'>
            <div className=''>
                ...
                <p className='text-sm font-extralight pt-4'>Tashina is a Web3 coach motivating individuals and professionals to get involved with decentralized systems.</p>
                <p className='text-sm font-extralight pt-4'>Residing in Canada, Tashina spends time hiking the rocky mountains and traveling to new inspiring destinations.</p>
                <p className='text-sm font-extralight pt-4'>Say hi! Reach out over social media and lets work togeher in making Web3 inclusive for everyone.</p>
                <Socials />
